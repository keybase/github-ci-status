...
function start() {
  var status, sha, _ref, user, repo, _state_to_logsymbol$s, symbol, color;
      ...
      switch (_context.prev = _context.next) {
        ...
        case 35:
          if (status.statuses.length < 3) {
            console.error(logSymbols[symbol], chalk[color]('The required number of tests weren\'t run (' + status.statuses.length + ' vs 3)'));
            process.exit(4);
          }
